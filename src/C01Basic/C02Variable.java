...
////
//////        boolean : true or false(boolean 타입은 대부분 조건절에 사용
////        boolean b1 = true;
...
//         int b = 4;
//         double d = a/b;
//        System.out.println(d);  // 정수 / 정수 의 경우 소수점 절사문제 발생
//
////        두 정수중에 한 정수만이라도 double로 형변환시 소수점 절사 문제 해결
//        double c = (double)a/b;
...
//
////        상수는 초기값을 이후에 재할당하는것이 불가능 . 상수는 final키워드를 통해 표현
//    final int AGES = 20;
////    AGES = 30;
